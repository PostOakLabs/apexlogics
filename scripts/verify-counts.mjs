...
const ATTR_RULES = [
  ...
  { file: 'mcp.html', key: 'workflows', label: 'og:description (workflow chains)',
    regex: /(edtech and careertech tools, )(\d+)( workflow chains)/,
  },
  { file: 'mcp.html', key: 'tools', label: 'twitter:description',
    regex: /(catalog search across )(\d+)( tools, \d+ multi-step workflow chains)/,
  },
  { file: 'mcp.html', key: 'workflows', label: 'twitter:description (workflow chains)',
    regex: /(tools, )(\d+)( multi-step workflow chains)/,
  },
  ...
  { file: 'mcp.html', key: 'workflows', label: 'JSON-LD description (workflow chains)',
    regex: /(workflow chain builder covering )(\d+)( multi-step analyses)/,
  },
  { file: 'mcp.html', key: 'workflows', label: 'stat row (workflow chains)',
    regex: /(<div class="stat-num">)(\d+)(<\/div><div class="stat-label">Workflow chains<\/div>)/,
  },
  { file: 'mcp.html', key: 'workflows', label: 'build_workflow_links table intro',
    regex: /(a named multi-tool workflow chain \()(\d+)( chains — e\.g\.)/,
  },
  { file: 'mcp.html', key: 'workflows', label: 'workflows section heading',
    regex: /(<h2 class="sec-heading">)(\d+)( multi-step analyses<\/h2>)/,
  },
